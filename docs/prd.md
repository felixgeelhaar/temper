...
1. Executive Summary
   ...
   • Receive calibrated feedback
   • Retain authorship and intent
   • Grow from novice to expert without losing autonomy
   ⸻
2. Problem Definition
   ...
   • We do not default to generation
   • We do not remove cognitive effort
   ⸻
...
6. Understanding beats speed
7. The user is always the author
8. Intervention is adaptive, not user-toggled
...
13. Business Model (Exploratory)
    • B2C: Premium subscription (craft mastery)
    • B2B (later): Onboarding, upskilling, interview prep
    • Expansion via depth, not volume
